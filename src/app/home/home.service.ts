...
export class HomeService {
  ...
  getHomeElements(
    language: string,
    forceRefresh = false,
  ): Observable<HomeElementModel> {
    return this.http
      .get<HomeElementResponse[]>(this.pageElementsApi, {
        params: { language },
        // Request coalescing and replay now live in HttpCacheInterceptor, which
        // dedupes across services rather than only within this one.
          ...
          return {
            ...
            trackingElementModel: trackingElementResponse
              ? {
                  ...
                  subtitle_size:
                    trackingElementResponse?.['0(page_element)'].subtitle_size,
                  backgroundColor: trackingElementResponse?.['0(page_element)']
                    .background_color
                  ...
                  textColor: trackingElementResponse?.['0(page_element)']
                    ...
                    : null,
                  backgroundImage: trackingElementResponse?.['0(page_element)']
                    .primary_image
                    ? new URL(
                        `/data/download/${
            ...
            newsElementModel: newsElementsResponse
              ? {
                  ...
                  backgroundColor: newsElementsResponse['0(page_element)']
                    ...
                    : null,
                  textColor: newsElementsResponse['0(page_element)'].text_color
                  ...
                  backgroundImage: newsElementsResponse['0(page_element)']
                    ...
                    : null,
                  icon: newsElementsResponse['0(page_element)'].secondary_image
                    ? new URL(
                        `/data/download/${
                          newsElementsResponse['0(page_element)']
                            .secondary_image[0].name
                ...
                ? contentImageResponses.map((response) => {
                    return {
                      ...
                      imageUrl: response?.['0(page_element)'].primary_image
                        ? new URL(
                            `/data/download/${
                              response['0(page_element)'].primary_image[0].name
                            }?attribute_id=cc6d340b-2728-4bdb-95c3-90feb97dbcb2&file_id=${
                      ...
                      icon: response?.['0(page_element)'].secondary_image
                        ? new URL(
                            `/data/download/${
                              ...
                              response['0(page_element)'].secondary_image[0].id
                            }&version=0&token=${this.authService.getToken()}`,
                            AUTH_CREDENTIALS.app_url,
                          ).toString()
                        : null,
            ...
            selfieElementModel: selfieElementResponse
              ? {
                  ...
                  backgroundColor: selfieElementResponse['0(page_element)']
                    ...
                    : null,
                  textColor: selfieElementResponse['0(page_element)'].text_color
                  ...
                  icon: selfieElementResponse?.['0(page_element)']
                    ...
                    : null,
                  shareText: selfieElementResponse['0(page_element)'].subtitle,
